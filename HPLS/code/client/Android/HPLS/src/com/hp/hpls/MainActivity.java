...
public class MainActivity extends Activity
{
	...
	private class AssetsExtracter extends AsyncTask<Integer, Integer, Boolean>
	{
		...
		protected void onPostExecute(Boolean result) 
		{
			...
			if (result)
			{
				...
				mWebView.loadUrl("file:///android_asset/Menu/index2.html");
	...
	class WebViewHandler extends WebViewClient
	{
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) 
		{
			...
			final String tutorialId = url.substring(url.lastIndexOf("=") + 1)+"Activity";
			...
			if (url.toLowerCase(Locale.US).startsWith("metaiosdkexample://"))
			{
				...
				try 
				{
					Log.d("Albert", "getPackageName(): " + getPackageName());
